...
Notes:
    ...
    - Preprocessing uses facenet-pytorch MTCNN with GPU support if available.
    - Do not run during training; model.py uses the processed images which this script outputs.
"""
